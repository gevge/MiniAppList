...
This privacy policy applies to the Mini App List app (hereby referred to as "Application") for mobile devices that was created by gevge (hereby referred to as "Service Provider") as an Open Source service. This service is intended for use "AS IS".
...
If you have any questions regarding privacy while using the Application, or have questions about the practices, please contact the Service Provider via email at gevge.dev@gmail.com .
